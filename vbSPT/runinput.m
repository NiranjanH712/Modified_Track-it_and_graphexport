...
init_D = [0.001, 10];           % interval for diffusion constant initial guess [pixel^2/frame] in same length units as the input data.
% init_D = [10, 4000];           % interval for diffusion constant initial guess [pixel^2/frame] in same length units as the input data.
init_tD = [2, 20]*timestep;     % interval for mean dwell time initial guess in [frames].
